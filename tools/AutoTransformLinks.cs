...
public class TransformLinksAutomation : EditorWindow
{
    ...
    [MenuItem("Tarkov Weapon Tools/Transform Links Automation")]
    ...
    private void ApplyTransformLinks()
    {
        ...
        // Check for "prop" bone and add it if it exists.
        ...
        for (int i = 0; i < transformCount; i++)
        {
            ...
            {
                // Bone doesn't exist, set the transform link to null
...
private void SetCachedTransform(GameObject rootObject, string boneName, int index)
{
    ...
    if (bone != null)
    {
        ...
        {
            // If rotation is not (0, 0, 0), calculate and set the quaternion.
